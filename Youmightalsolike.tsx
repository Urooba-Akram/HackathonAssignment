...
const TopSeller = () => {
  const card: TopSellerData[] = [
    {
      id: 1,
      image: "/Polo with Contrast Trims.png", // Correct path
    ...
    {
      id: 2,
      image: "/Gradient Graphic T-shirt.png", // Correct path
    ...
    {
      id: 3,
      image: "/Polo with Tipping Details.png", // Correct path
    ...
    {
      id: 4,
      image: "/Black Striped T-shirt.png", // Correct path
    ...
    if (priceWas) {
      const discount =
        ((parseFloat(priceWas.replace("$", "")) - 
          ...
          parseFloat(priceWas.replace("$", ""))) * 100;
    ...
    <div>
      ...
      <div className="w-[90%] border-b-2 border-gray-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 m-auto">
        {card.map((item) => (
          ...
          >
            <div className="relative w-100 h-[300px] rounded-[20px] overflow-hidden">
              <Image
                src={item.image} // Correct image path
                alt={item.title}
                layout="fill"
                objectFit="cover"
